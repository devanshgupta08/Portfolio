...
const Contact = () => {
  return (
    <>
      <section
        id="contact"
        className="EXPERIENCE dark:bg-[#111827] p-5 mt-[5rem] xl:mt-[-5rem] font-['Poppins']  max-sm:p-2 "
      >
        <div className="bg-gradient-to-tl from-[#e1e1e1] to-[#fff] dark:from-[#111827] dark:to-[#111827] dark:shadow-none rounded-2xl shadow-xl WRAPPER mx-2 flex justify-between p-7 mb-7 max-sm:flex-col-reverse max-sm:p-2">
          <div className="ABOUT p-7">
            ...
            <div className="SOCIALS text-[#00040f] dark:text-white text-2xl flex gap-7 mt-5 max-sm:justify-evenly">
              <a
                href="https://github.com/devanshgupta08"
                className=" hover:text-slate-500  dark:hover:text-sky-300"
              >
                <SiGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/devansh-gupta-236bb7257/"
                target="_blank"
                className=" hover:text-slate-500  dark:hover:text-sky-300"
              >
                <SiLinkedin />
              ...
              <a
                href="https://www.instagram.com/dg_0802"
                target="_blank"
                className=" hover:text-slate-500  dark:hover:text-sky-300"
              >
                <SiInstagram />
              ...
              <a href="https://mail.google.com/mail/?view=cm&to=devansh00gupta@gmail.com" 
                target="_blank"
                className=" hover:text-slate-500  dark:hover:text-sky-300"
              >
                <SiGmail />
            ...
            <div className="flex gap-5 max-sm:justify-center">
              <button className="py-3 px-4 bg-gradient-to-t dark:from-cyan-500 dark:to-slate-300  from-blue-600 to-cyan-600 font-medium text-[12px] text-[#e1e1e1] dark:text-black outline-none mt-10 mr-3 rounded ">
                <a 
                href="https://drive.google.com/file/d/1I8Xfl5KNAOHzb900Xu74o-xhJkVoWDhR/view?usp=sharing"
                target="_blank"
                >Resume</a>
              </button>
              <button className="py-3 px-4 bg-gradient-to-t dark:from-cyan-500 dark:to-slate-300 from-blue-600 to-cyan-600  font-medium text-[12px] text-[#e1e1e1] dark:text-black outline-none mt-10 mr-3 rounded ">
                <a
                  href="https://github.com/devanshgupta08/Portfolio"
